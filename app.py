...
st.markdown(
    '''
    <div class="header">
        <img src="https://chambermaster.blob.core.windows.net/images/customers/1613/members/871/logos/MEMBER_PAGE_HEADER/Liberty_Logo_Horizontal_RGB.PNG" alt="Liberty Logo" style="height:40px;">
